...
export const CONTRACTS = {
  ...
  97: {
    ...
    // Event PK Challenge Contract (deployed 2026-01-15)
    EVENT_PK_CHALLENGE: '0xD9F9B4Ddac50fF219f9121F02e83f9e6Ffce0369',
  },
  // BSC Mainnet
  56: {
    ...
    USDT_PRICE_MARKET_FACTORY: '0x0000000000000000000000000000000000000000',
    ...
    EVENT_PK_CHALLENGE: '0x0000000000000000000000000000000000000000',
  },
};
...
export function getContractAddress(
  chainId: number,
  contract: 'FACTORY' | 'CHAINLINK_ADAPTER' | 'PRICE_MARKET_FACTORY' | 'USDT_PRICE_MARKET_FACTORY' | 'TEST_MARKET_BTC_1H' | 'MOCK_USDT' | 'USDT_FAUCET' | 'PK_CHALLENGE' | 'EVENT_PK_CHALLENGE'
) {
